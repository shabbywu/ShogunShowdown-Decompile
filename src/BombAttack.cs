...
{
	public override AttackEnum AttackEnum => AttackEnum.bomb;

	public override string LocalizationTableKey { get; } = "Bomb";
	...
	public override bool Begin(Agent attackingAgent)
	{
		...
		if ((Object)(object)cell != (Object)null)
		{
			...
			Object.Instantiate<GameObject>(Resources.Load<GameObject>("Combat/CombatObjects/Bomb"), ((Component)attacker).transform.position, Quaternion.identity).GetComponent<Bomb>().Initialize(base.Value, base.AttackEffect, attacker, cell);
			attacker.RegisterAttackInProgress(Bomb.placingTime);
			return true;
		}
		return false;
	}
